...
#ACTIVATE THE ENVIRONMENT
#COPY PROJECT FILES INTO THE ENVIRONMENT
#THEN RUN THE PYTHON SCRIPT TO PUT UP THE SERVER
#THERE SHOULD BE A WAY TO KNOW IF THE PORTS ARE FAILING SO THAT WAY WE CAN CHANGE PORTS WITHOUT HAVING TO REPORT THAT AS AN ERROR
